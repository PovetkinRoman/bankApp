...
/**
 * OAuth2 configuration for Transfer service.
 * 
 * This configuration enables Transfer service to authenticate with Keycloak
 * and make authorized calls to other services using client credentials flow.
 */
@Configuration
